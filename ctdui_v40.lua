...
-- Build: PASS30-MONOLITH-AUTORETRY-RECONNECT-RECORDER-V40
...
session.reliabilityBuild = "PASS30-MONOLITH-AUTORETRY-RECONNECT-RECORDER-V40"
print("[XOMA V40] Auto Retry forced ON | reconnect installed | recorder -> V40")
return session.XOMA
]===]
    local chunk, err = loadstring(source)
